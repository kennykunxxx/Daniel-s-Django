...
from dvd.forms import dvd_forms
from django.contrib.auth.decorators import login_required
...
def dashboard(request):
    ...
    length_list = len(movie_list)
    return render(request, 'movie/dashboard.html', {'length_list': length_list})
...
def user_list(request):
    ...
    form = dvd_forms()
    return render(request, 'movie/user_list.html', {'movie_list': movie_list, 'form': form})
